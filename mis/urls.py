...
from mis.views import (AccessRequestCreateView, AccessRequestListView, AccessSuccessListView, ApprovedIBView,
                       ApprovedOwnerView, ApprovedSupervisorView, InformationSystemCreateView,
                       InformationSystemDeleteView, InformationSystemListView, InformationSystemRoleCreateView,
                       InformationSystemRoleDeleteView, InformationSystemRoleListView, InformationSystemRoleUpdateView,
                       InformationSystemUpdateView, RejectedIBView, RejectedOwnerView, RejectedSupervisorView)
...
urlpatterns = [
    ...
    path(
        "information_system/<int:pk>/update/", InformationSystemUpdateView.as_view(), name="informationsystem_update"
    ),
    path(
        "information_system/<int:pk>/delete/", InformationSystemDeleteView.as_view(), name="informationsystem_delete"
    ),
    path("information_system_role/", InformationSystemRoleListView.as_view(), name="informationsystemrole_list"),
    path(
        "information_system_role/create/",
        InformationSystemRoleCreateView.as_view(),
        name="informationsystemrole_create",
    ),
    path(
        "information_system_role/<int:pk>/update/",
        InformationSystemRoleUpdateView.as_view(),
        name="informationsystemrole_update",
    ),
    path(
        "information_system_role/<int:pk>/delete/",
        InformationSystemRoleDeleteView.as_view(),
        name="informationsystemrole_delete",
    ),
]
